...
import (
	"flag"
	"github.com/daniel-hutao/application-operator/apis/apps/v1"
	"github.com/daniel-hutao/application-operator/apis/apps/v2"
	"os"
	...
	"github.com/daniel-hutao/application-operator/controllers/apps"
